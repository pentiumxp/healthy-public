...
function normalizeWorkout(input) {
  ...
  return {
    ...
    elevationGainM: numberOrNull(input.elevationGainM ?? input.elevation_gain_m ?? input.totalElevationGainM ?? input.total_elevation_gain_m ?? input.elevationAscendedM ?? input.elevation_ascended_m),
    elevationLossM: numberOrNull(input.elevationLossM ?? input.elevation_loss_m ?? input.totalElevationLossM ?? input.total_elevation_loss_m ?? input.elevationDescendedM ?? input.elevation_descended_m),
    activeEnergyKcal: numberOrNull(input.activeEnergyKcal ?? input.active_energy_kcal),
    totalEnergyKcal: numberOrNull(input.totalEnergyKcal ?? input.total_energy_kcal),
    averageHeartRateBpm: numberOrNull(input.averageHeartRateBpm ?? input.average_heart_rate_bpm),
    ...
    sourceName: stringOrNull(input.sourceName ?? input.source_name),
    sourceBundleIdentifier: stringOrNull(input.sourceBundleIdentifier ?? input.source_bundle_identifier),
    deviceName: stringOrNull(input.deviceName ?? input.device_name),
    deviceManufacturer: stringOrNull(input.deviceManufacturer ?? input.device_manufacturer),
    deviceModel: stringOrNull(input.deviceModel ?? input.device_model),
